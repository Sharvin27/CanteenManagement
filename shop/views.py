...
def checkout(request):
    if request.method == "POST":
        ...
        phone = request.POST.get('phone', '')
        order = Orders(items_json=items_json, userId=user_id, name=name, email=email, address='CRCE Bandra', city=city, state=state, zip_code='400050', phone=phone, amount=amount)
        order.save()
